 ...
 * @author austynhill
 */
public class LlamaDAOFileImplCrudTest {
    
    LlamaDAOFileImpl testDAO;
    
    public LlamaDAOFileImplCrudTest() throws IOException {
        String testFileName = "testherd.txt";
        new FileWriter(testFileName);
        testDAO = new LlamaDAOFileImpl(testFileName);
    }

    @Test
    public void addGetOneLlamaTest() throws LlamaDAOException {
    ...
    @Test
    public void addGetAllLlamaTest() throws LlamaDAOException {
        // ARRANGE - already know we have a blank DAO
        // we also need a llama, and an id
        String llamaID = "DA FLOOFY ONE";
        Llama toStore = new Llama(llamaID, "Purple", "Purple floofmeister", 12, "Grapes");
    ...
    @Test
    public void addRemoveLlamaTest() throws LlamaDAOException {
        // ARRANGE
        // we also need a llama, and an id
        String llamaID = "DA FLOOFY ONE";
        Llama toStore = new Llama(llamaID, "Purple", "Purple floofmeister", 12, "Grapes");
    ...
    @Test
    public void addEditLlamaTest() throws LlamaDAOException {
        // ARRANGE
        String llamaID = "DA FLOOFY ONE";
    ...
    @Test
    public void emptyDAOTest() throws LlamaDAOException {
