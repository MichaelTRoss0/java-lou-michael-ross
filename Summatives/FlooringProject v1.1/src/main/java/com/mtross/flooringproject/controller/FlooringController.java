...
public class FlooringController {
    ...
    private void displayOrders() {
        ...
        try {
            ...
            String errorMsg = "There are no orders for that date.";
    ...
    private void addAnOrder() {
        ...
        do {
            try {
                ...
                String errorMsg = "The name cannot be blank and can only contain"
                        + "[a-z][1-9] as well as spaces, period, and comma characters.";
                view.displayErrorMessage(errorMsg);
                tryAgain = true;
            }
        } while (tryAgain);
        ...
        do {
            try {
                ...
                service.verifyProduct(productType, products);
                tryAgain = false;
            } catch (FlooringInvalidInputException e) {
    ...
    private void editAnOrder() {
        ...
        do {
            try {
                ...
                service.verifyProduct(newProductType, service.getEveryProduct());
                tryAgain = false;
            } catch (FlooringInvalidInputException e) {
                String errorMsg = "That is not on the list of products we sell";
                view.displayErrorMessage(errorMsg);
